...
?>
<div>
<img src="gallery/bedroom/family-suite/1.png" alt="single-suite bed" style="width:100%; height:580px;">
<!--Single Suite-->
...
<div class="container-fluid bg-transpa">
	<div class="row">
		<div class="col-md-6" style="text-align: justify;">
			...
			<p style="padding:20px 60px;">If you are looking for a reunion or a family vacation, family suit is what you are looking for.Furnished with three single beds and one double bed and offers more space than the standard rooms.Enjoy different activites such as gaming,swimming,sight seeing etc.You can also relax in our spa and sauna.Use free Wi-Fi to stream your favorite show on the TV. At the end of the day, you can relax with the soothing rain shower in the spacious bathroom. Other amenities include a wardrobe, double-glazed windows, and an in-room safe to secure your valuables. </p>
		</div>
		<div class="col-md-6">
			<div class="inner">
				...
				<div id="demo" class="carousel slide" data-ride="carousel">
				    ...
				    <div class="carousel-inner">
				     	<div class="carousel-item active">
				     		<img src="gallery/bedroom/family-suite/1.png" style="height: 500px; width: 100%;">
				    	...
				    	<div class="carousel-item">
				       		<img src="gallery/bedroom/family-suite/3.png" style="height: 500px; width: 100%;">
				    	</div>    
				  	</div>
...
<div class="container-fluid bg-transpa" style="margin-top: 5px; margin-top: -.07px">
	...
	<?php 
		...
		<div class="container bg-transpare price" style="margin-top: -0.3px; padding: 20px 0px 15px;">
			<p> Pack Rate BDT <?php echo $resr5['price']; ?></p>
		</div><br><br>
		<?php
	}
	...
	<div class="row">
		<div class="col-md-6">
			<div class="container text-center">
				...
				<img src="gallery/underline.png" style="width: 200px; height: 60px; margin-top: -45px; padding-left: 5px;"><br>
				<ul class="amenities">
					<li><i class="fas fa-bed fontawe"></i>Three single bed with one double bed</li>
