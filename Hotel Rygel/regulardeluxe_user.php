...
?>
<div>
<img src="gallery/bedroom/single-deluxe/2.jpg" alt="single-suite bed" style="width:100%; height:580px;">
<!--Single Suite-->
				...
				<div id="demo" class="carousel slide" data-ride="carousel">
				    ...
				    <div class="carousel-inner">
				    	...
				    	<div class="carousel-item">
				        	<img src="gallery/bedroom/single-deluxe/2.jpg" style="height: 500px; width: 100%;">
				    	</div>
				    	<div class="carousel-item">
				       		<img src="gallery/bedroom/single-deluxe/3.jpg" style="height: 500px; width: 100%;">
				    	</div> 
				    	<div class="carousel-item">
				       		<img src="gallery/bedroom/single-deluxe/4.png" style="height: 500px; width: 100%;">
				    	</div>    
				  	</div>
...
<div class="container-fluid bg-transpa" style="margin-top: 5px; margin-top: -.07px">
	...
	<?php 
		...
		<div class="container bg-transpare price" style="margin-top: -0.3px; padding: 20px 0px 15px;">
			<p> Pack Rate BDT <?php echo $resr2['price']; ?></p>
		</div><br><br>
		<?php
			}
	...
	<div class="row">
		<div class="col-md-6">
			<div class="container text-center">
				...
				<img src="gallery/underline.png" style="width: 200px; height: 60px; margin-top: -45px; padding-left: 5px;"><br>
				<ul class="amenities">
					<li><i class="fas fa-bed fontawe"></i> One Double Bed</li>
